...
function info(){
    let thing = document.getElementById("content");
    thing.innerHTML=`<h1> <b>Informazioni su Rob-erto</b> </h1>
                        <p> Rob-erto è un figo fighissimo tipo un figo figone </p>
                        <h3> Rob-erto rob bot rob erta </h3>
                        <b> si fossi foco </b>
                        <p> Tortellini alla Paulo dybala con tanta neeneneneneneneve </p>
                        `;
}
function funzioni(){
    let thing = document.getElementById("content");
    thing.innerHTML=`<h1> <b>Funzioni di Rob-erto</b> </h1>
                        <p> oh Rob-erto fa un botto di cose </p>
                        <h6> ma tipo un sacco </h6>
                        <em> Traduce cose </em>
                        <h4> è matto in culo</h4>
                        `;
}
function creators(){
    let thing = document.getElementById("content");
    thing.innerHTML=`<h1><b>Creatori di Rob-erto Rob-erto </b></h1>
